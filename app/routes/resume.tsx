...
const Resume = () => {
    ...
    useEffect(() => {
        const loadResume = async () => {
            ...
            console.log({resumeUrl, imageBlobUrl, feedback});
        }
        ...
        <main className='!pt-0'>
            ...
            <div className='flex flex-row w-full max-lg:flex-col-reverse'>
                <section className="feedback-section bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-center">
                    {imageUrl && resumeUrl && (
                        <div className='animate-in duration-1000 gradient-border max-sm:m-0 h-[90%] max-w-xl:h-fit w-fit'>
                            <a href={resumeUrl} target='_blank' rel='noreferrer' className='w-full h-full'>
